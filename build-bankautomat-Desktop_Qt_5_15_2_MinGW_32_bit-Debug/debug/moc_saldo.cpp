...
QT_MOC_LITERAL(3, 23, 29), // "on_kirjauduulos_sadlo_clicked"
QT_MOC_LITERAL(4, 53, 8), // "timerout"
QT_MOC_LITERAL(5, 62, 15), // "tilitiedotDebit"
QT_MOC_LITERAL(6, 78, 24) // "on_PalaaTakaisin_clicked"

    },
    "saldo\0transactionSlot\0\0"
    "on_kirjauduulos_sadlo_clicked\0timerout\0"
    "tilitiedotDebit\0on_PalaaTakaisin_clicked"
};
...
void saldo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->transactionSlot((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->on_kirjauduulos_sadlo_clicked(); break;
        case 2: _t->timerout(); break;
        case 3: _t->tilitiedotDebit((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 4: _t->on_PalaaTakaisin_clicked(); break;
        default: ;
        }
    }
}
